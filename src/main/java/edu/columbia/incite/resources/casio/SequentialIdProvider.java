...
import edu.columbia.incite.resources.casio.IdProvider;

/**
 * An {@link IdProvider} implementation that provides sequential integer-valued id's for 
 * annotations.
 * 
 * Uniqueness may be defined with respect to all annotations, or with respect to each annotation 
 * type.
 * 
