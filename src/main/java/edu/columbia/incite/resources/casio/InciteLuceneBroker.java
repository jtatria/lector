...
/**
 * An InciteBroker to create and populate instances od Lucene's @link{Document}.
 * 
 * @author José Tomás Atria <jtatria@gmail.com>
 */
public class InciteLuceneBroker extends InciteBroker<Document> {
    
    private static final byte[] DEAD_BEEF = new byte[] { 0xd, 0xe, 0xa, 0xd, 0xb, 0xe, 0xe, 0xf };
    
    public static final String  DFLT_STRING   = new String( DEAD_BEEF, Tokenizer.CS );
