...
import edu.columbia.incite.io.charstreams.CharStreamProcessor;
import edu.columbia.incite.io.charstreams.BufferFilter;
...
public class InciteSaxHandler extends Resource_ImplBase implements SaxHandler {
     ...
     * performed by a {@link BufferFilter}, if one is configured. The end offset will be adjusted 
     ...
     * handler is configured to create annotations and the and the configured 
     * {@link MappingProvider} indicates that the XML element name of the currently processing 
     * element corresponds to a UIMA annotation.
     *
     ...
     * modifications to the character stream performed by a {@link BufferFilter}, in one is 
