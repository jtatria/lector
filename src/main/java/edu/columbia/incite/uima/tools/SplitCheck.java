 ...
 * {@link org.xml.sax.ContentHandler#characters(char[], int, int) } method will be called when 
 * processing mixed-content XML documents. E.g. if a source uses XML elements to indicate newline 
 * or paragraph breaks that split words, the parts of the word before and after the break will be
 * passed to a handler in different chunks.
 * 
