 ...
 * 
 * This resource should receive a reference to an empty CAS from the 
 * {@link #configure(java.lang.Object) } method in order to allow the handler to access and write
 * CAS data from XML data.
 * 
